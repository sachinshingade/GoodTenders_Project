...
<html class="no-js" lang="zxx">
	...
	<link href="assets/css/colors/orange-style.css" rel="stylesheet">
	...
	<body>
			...
			<form class="form-horizontal" action="showtenders.php" method="post" target="_blank">
				...
				<div class="col-sm-12 col-xs-12 col-md-4 " style="margin: 10px 0 10px 0">
					...
					<div class="col-md-3 col-xs-12" style="margin-top: 10px">
						<input type="submit" id="search" onclick="" class="btn btn-primary searchbtn">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 no-padd sector_div">
						<select class="sector" data-style="form-control" data-width="100%" title="Select a Sector" data-size="3" name="isector">
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 no-padd">
						<select class="selectpicker" data-style="form-control" data-width="100%" title="Select Funding Type" name="ifunding_type">
							<option disabled >-- Funding Type --</option>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 no-padd">
						<select class="selectpicker" data-style="form-control" data-width="100%" title="Live Tenders" data-size="2" data-dropup-auto="true" name="ilive">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 no-padd">
						<select class="selectpicker" data-style="form-control" data-width="100%" title="Tender Value" name="itender_value">
							<option disabled>-- Select Tender Value --</option>
        ...
        <?php
  			...
  			$sql = "SELECT B.*, A.Country FROM tbl_tenders AS B INNER JOIN tbl_country as A ON (B.org_country=A.code) ORDER BY RAND() LIMIT 10";
				...
				<div class="row lg-menu">
					<div class="container">
						<div class="col-md-4 col-sm-4">
							<h2 style="margin-top:15px;color:#07b107;">GoodTenders</h2> 
						</div>
						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="textwidget">
								...
								<ul class="footer-navigation">
									<li><a href="policy.php" title="">Privacy Policy</a></li>
									<li><a href="terms_conditions.php" title="">Terms of Use</a></li>
									<li><a href="getBackSoon.php" title="">Site Map</a></li>
								</ul>
							</div>
							</div>
							</div>
				...
				<div class="modal-dialog modal-login">
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <a href="javascript:void(0)"  data-toggle="modal" data-target="#lostpassword" class="btn btn-link btm_btn" data-dismiss="modal" 
